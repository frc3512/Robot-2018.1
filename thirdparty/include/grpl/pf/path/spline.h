...
public:
     ...
     * value 't'
     *
     * @param t The spline parameter, where 0 is the start and 1 is the end of
     * the spline.
    ...
    /**
     * Calculate the derivative of a point on the spline, at any spline
     * parameter value 't' (the derivative of @ref position(double))
     *
     * @param t The spline parameter, where 0 is the start and 1 is the end of
     * the spline.
     ...
     * @param t The spline parameter, where 0 is the start and 1 is the end of
     * the spline.
     * @return  The rotation (unit derivative) at spline parameter 't',
     * unitless.
     */
