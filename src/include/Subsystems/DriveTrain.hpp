...
public:
    ...
    */
     ...
     * @param rightVelocity Velocity of the right side in meters.
     */
    void SetReferences(double leftPosition, double leftVelocity, double rightPosition, double rightVelocity);
