...
#include "frc/controllers/PeriodVariantPlantCoeffs.h"
...
private:
    ...
    std::vector<PeriodVariantPlantCoeffs<States, Inputs, Outputs>>
        m_coefficients;
    int m_index = 0;
};
...
#include "frc/controllers/PeriodVariantPlant.inc"
