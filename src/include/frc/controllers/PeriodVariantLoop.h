...
#include "frc/controllers/PeriodVariantController.h"
#include "frc/controllers/PeriodVariantKalmanFilter.h"
#include "frc/controllers/PeriodVariantPlant.h"
...
public:
    ...
    PeriodVariantLoop(PeriodVariantLoop&& rhs);

    virtual ~PeriodVariantLoop() = default;

    PeriodVariantLoop(const PeriodVariantLoop&) = delete;
    PeriodVariantLoop& operator=(const PeriodVariantLoop&) = delete;
     ...
     */
    const PeriodVariantController<States, Inputs, Outputs>& GetController()
        const;

    /**
     * Return the observer used internally.
     */
    const PeriodVariantKalmanFilter<States, Inputs, Outputs>& GetObserver()
        const;
...
#include "frc/controllers/PeriodVariantLoop.inc"
