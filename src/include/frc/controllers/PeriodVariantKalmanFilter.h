...
#include "frc/controllers/PeriodVariantKalmanFilterCoeffs.h"
...
public:
    ...
    /**
     * Returns an element of the discretized measurement noise covariance
     * matrix.
     *
     * @param i Row of R.
     * @param j Column of R.
...
#include "frc/controllers/PeriodVariantKalmanFilter.inc"
