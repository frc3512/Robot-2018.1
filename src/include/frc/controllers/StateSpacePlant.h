...
public:
    ...
    StateSpacePlant(StateSpacePlant&& rhs);

    virtual ~StateSpacePlant() = default;

    StateSpacePlant(const StateSpacePlant&) = delete;
    StateSpacePlant& operator=(const StateSpacePlant&) = delete;
    ...
    /**
     * Sets the current plant to be "index", clamped to be within range. This
     * can be used for gain scheduling to make the current model match changed
     * plant behavior.
     *
...
#include "frc/controllers/StateSpacePlant.inc"
