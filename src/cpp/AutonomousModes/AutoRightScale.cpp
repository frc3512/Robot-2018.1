    ...
    switch (state) {
        case State::kInit:
            ...
            if (platePosition[kScale] == 'R') {
                ...
                positionProfile.SetGoal(236.5 + 10.0 - kRobotLength / 2.0);
            }
        ...
        case State::kFinalRotate:
            if (angleProfile.AtGoal() ||
                ...
                if (platePosition[kScale] == 'R') {
                    ...
                    positionProfile.SetGoal(56.0 + 22.0 - kRobotLength / 2.0);
                }
        ...
        case State::kPrepReverse:
            if (autoTimer.HasPeriodPassed(1.0)) {
                if (platePosition[kScale] == 'R') {
                    positionProfile.SetGoal(-24.0 - 33.0 + kRobotLength / 2.0);
                } else {
